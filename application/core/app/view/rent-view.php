...
<div class="row">
	...
	<p><b>Buscar producto por Número de serie o por modelo:</b></p>
		<form id="searchp">
		<div class="row">
			<div class="col-md-3">
...
$(document).ready(function(){
    ...
    name = $("#product_name").val();
		if(name!=""){
		$.get("./?action=searchproductbyserieandmodel",$("#searchp").serialize()+"&go=name",function(data){
			$("#show_search_results").html(data);
		});
		$("#product_name").val("");
    }
    else if(code!=""){
    $.get("./?action=searchproductbyserieandmodel",$("#searchp").serialize()+"&go=code",function(data){
      $("#show_search_results").html(data);
    });
    $("#product_code").val("");
    }
