...
// partiendo de que ya tenemos creado un objecto ProductData previamente utilizamos el contexto
	...
	public static function getOnlyFinished() {
		$sql = "select * from " . self::$tablename . " where status=1 AND is_active=1 AND id not in(SELECT product_id from operation where operation_type_id=2)";
		$query = Executor::doit($sql);
		return Model::many($query[0], new ProductData());
	}
